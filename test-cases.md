...
| TC-011 | Add multiple quantities of same product | User logged into the application and product available | 1. Add a product to the cart 2. Attempt to add the same product again from inventory page 3. Open cart and attempt to increase quantity | User can add or increase quantity of the same product, or the system clearly explains the limitation | Medium |
